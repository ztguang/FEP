...
plot 'fep-test-cpu-mem-docker.dat' using 1:2 title "CPU Utilization for Docker" with linespoints pointtype 2, \
     'fep-test-cpu-mem-docker.dat' using 1:3 title "MEM Utilization for Docker" with linespoints pointtype 3, \
     'fep-test-cpu-mem-lineage.dat' using 1:2 title "CPU Utilization for Lineage" with linespoints pointtype 4, \
     'fep-test-cpu-mem-lineage.dat' using 1:3 title "MEM Utilization for Lineage" with linespoints pointtype 5
